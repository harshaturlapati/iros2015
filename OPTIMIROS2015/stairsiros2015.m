...
lb=[0.01 0.01 0.01 0.01 0.1 0.1 0.1 0.1 -inf -inf];%LOWER BOUNDS
...
%display(normforce)
figure(1);
subplot(2,2,1);plot(phi(:,1));ylabel('angle - phi1');
subplot(2,2,2);
plot(phi(:,2));ylabel('angle - phi2');
subplot(2,2,3);scatter(phi(:,1),tau(:,1));ylabel('tau1');xlabel('phi1');
subplot(2,2,4);scatter(phi(:,2),tau(:,2));ylabel('tau2');xlabel('phi2');
figure(2);
